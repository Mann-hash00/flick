...
## neura-terminal-kit
**Files:** `neura-terminal-kit/terminal.tsx` (kit) · `theme.ts` · `common.tsx` · `TwoStrategiesScene.tsx` · `ThreeLosingHabitsScene.tsx` · `MentalTrapsScene.tsx` · `ThreeIndicatorsScene.tsx` · `PayoutStatScene.tsx` · `VISUAL-SYSTEM.md`
